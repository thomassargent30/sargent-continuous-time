"""
Clean redraws of the hand-drawn figures of Chapter 23 (Marcet, "Temporal
Aggregation of Economic Time Series").

Output files are named fig-23-N.png, where N is the figure number in Marcet's
original chapter (which the book retains).  The streamlined Chapter 23
currently displays only figures 1, 5 and 7; the remaining outputs of this
script are not committed to the repository, and are produced here so that they
are available should more of Marcet's exposition be restored.
...
clean(ax)
fig.tight_layout()
fig.savefig("fig-23-1.png", dpi=160, bbox_inches="tight")
print("wrote fig-23-1.png")
...
clean(ax)
fig.tight_layout()
fig.savefig("fig-23-2.png", dpi=160, bbox_inches="tight")
print("wrote fig-23-2.png")
...
clean(ax)
fig.tight_layout()
fig.savefig("fig-23-3.png", dpi=160, bbox_inches="tight")
print("wrote fig-23-3.png")
...
clean(ax)
fig.tight_layout()
fig.savefig("fig-23-4.png", dpi=160, bbox_inches="tight")
print("wrote fig-23-4.png")
...
clean(ax)
fig.tight_layout()
fig.savefig("fig-23-5.png", dpi=160, bbox_inches="tight")
print("wrote fig-23-5.png")
...
for ax, a, lab in zip(axes.ravel(), [a11, a12, a21, a22],
    ...
    clean(ax)
fig.tight_layout()
fig.savefig("fig-23-7.png", dpi=160, bbox_inches="tight")
print("wrote fig-23-7.png")
...
for fname, a_t, g_t, ylab, title in [
    ("fig-23-11.png", a_s, gs, r"$a_1,\ g$", "sampled"),
    ("fig-23-12.png", a_avg, ga, r"$\tilde a_1,\ \hat g$", "averaged"),
]:
